        ...
        <c:forEach items="${posts}" var="post">
            <div class="card left">
                <div class="card-image">
                    <img class="card-image-thumbnail" src="${post.writer.imageUrl}" alt="card-image-thumbnail"/>
                </div>
                <div class="card-text">
                    <h3 class="card-title">${post.title}</h3>
                    <div class="card-sub">${post.contents}</div>
                </div>
                ...
                <div class="card-footer">
                    <div class="date border">
                        ...
                        <div class="value">${post.createDateTime}</div>
                    </div>
                    <div class="views">
                        <div class="type">views</div>
                        <div class="value">${post.hits}</div>
                    </div>
                </div>
            </div>
        </c:forEach>
